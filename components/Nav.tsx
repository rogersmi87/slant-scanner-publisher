    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#FAFAF8]/95 backdrop-blur-sm border-b border-[#E2E0DA]">
      ...
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8" aria-label="Primary">
          ...
          <Link href="/" className="text-sm text-[#6B6860] hover:text-[#1A1A18] transition-colors">The app</Link>
          <a
            href="#lead-form"
      ...
      {open && (
        <div className="md:hidden border-t border-[#E2E0DA] bg-[#FAFAF8] px-6 py-4 flex flex-col gap-4">
          ...
          <Link href="/" onClick={() => setOpen(false)} className="text-sm text-[#6B6860]">The app</Link>
          <a
            href="#lead-form"
